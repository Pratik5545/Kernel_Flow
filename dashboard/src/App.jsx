...
export default function App() {
  ...
  // ✅ NAYA FUNCTION — Completed tasks clear karta hai
  async function clearCompleted() {
    await fetch('http://localhost:5000/api/tasks/clear-completed', {
      method: 'DELETE'
    })
  }
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100vh' }}>
      ...
      >
        {['ENQUEUE', 'FIFO QUEUE', 'DEQUEUE', 'EXECUTE', 'COMPLETE'].map((s, i, arr) => (
          <span key={s} style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            {i < arr.length - 1 && (
              <motion.span
                animate={{ opacity: [0.15, 0.6, 0.15], x: [0, 3, 0] }}
      ...
      <div style={{
        ...
        {/* ✅ COMPLETED LANE — Clear button ke saath */}
        <div style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', gap: 8 }}>

          {/* ✅ CLEAR BUTTON — Completed lane ke upar */}
          <div style={{ display: 'flex', justifyContent: 'flex-end', flexShrink: 0 }}>
            <button
              ...
              onMouseEnter={e => {
                ...
                e.target.style.boxShadow = '0 0 10px rgba(255,59,59,0.2)'
              }}
              onMouseLeave={e => {
